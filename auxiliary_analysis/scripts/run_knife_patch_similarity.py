#!/usr/bin/env python3
"""Build knife anchor patch and cosine heatmap for each configured model."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pixel", type=int, nargs=2, metavar=("X", "Y"), default=None, help="Anchor pixel in original RGB")
    ...
    parser.add_argument("--image", type=Path, default=None, help="Override knife image path")
